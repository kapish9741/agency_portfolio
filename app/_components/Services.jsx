...
import ServiceItem from './_Services/ServiceItem';

const Services = () => {
  const [activeService, setActiveService] = useState(null);

  return (
    <section className="relative w-full flex flex-col items-center overflow-clip">



      <div className='flex flex-col gap-4 pt-24 w-full max-w-[1400px] items-start px-20'>
        <motion.p
        ...
        <div className='absolute md:right-15 top-30 flex flex-col items-end justify-end gap-3'>
          <p className='font-dancing-script text-blue-700 text-xl rotate-[-5deg]'>How we add value!</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            viewBox="0 0 31 32"
            fill="none"
            className="w-15 h-15 text-blue-700 mb-2 rotate-230">
            <path
